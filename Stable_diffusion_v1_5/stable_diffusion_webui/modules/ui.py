                    ...
                    if category == "sampler":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="txt2img_column_size", scale=4):
                                width = gr.Slider(minimum=64, maximum=512, step=8, label="Width", value=256, elem_id="txt2img_width")
                                height = gr.Slider(minimum=64, maximum=512, step=8, label="Height", value=256, elem_id="txt2img_height")
                    ...
                    if category == "sampler":
                        ...
                        with FormRow():
                            with gr.Column(elem_id="img2img_column_size", scale=4):
                                width = gr.Slider(minimum=64, maximum=512, step=8, label="Width", value=512, elem_id="img2img_width")
                                height = gr.Slider(minimum=64, maximum=512, step=8, label="Height", value=512, elem_id="img2img_height")
                        ...
                        with FormGroup(elem_id="inpaint_controls", visible=False) as inpaint_controls:
                            ...
                            for i, elem in enumerate([tab_img2img,  tab_inpaint]):
                                elem.select(
